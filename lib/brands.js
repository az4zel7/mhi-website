...
products: [
      {
        ...
        description:
          "A versatile full-length track pant with a clean athletic silhouette, elasticated drawstring waist and practical side pockets. Designed with a streamlined fit that works equally well for workouts, running and everyday activewear.",
        images: [
          "/products/anicy/1/01.jpg",
          "/products/anicy/1/02.jpg",
          "/products/anicy/1/03.jpg",
          "/products/anicy/1/04.jpg",
          "/products/anicy/1/05.jpg",
          "/products/anicy/1/06.jpg",
        ],
      },
      {
        name: "4-Way Bermuda",
        description:
          "A clean athletic bermuda with a relaxed knee-length profile, elastic drawstring waistband and secure zippered side pocket. Its lightweight-looking construction makes it ideal for training, sports and casual outdoor wear.",
        images: [
          "/products/anicy/2/01.jpg",
          "/products/anicy/2/02.jpg",
          "/products/anicy/2/03.jpg",
          "/products/anicy/2/04.jpg",
          "/products/anicy/2/05.jpg",
        ],
      },
      {
        name: "4-Way Imported Track Pant — Belt Elastic",
        description:
          "A sleek tapered track pant featuring a structured elastic waistband, side pockets and a minimal athletic finish. The smooth surface and narrow-leg silhouette give it a more refined performance look.",
        images: [
          "/products/anicy/3/01.jpg",
          "/products/anicy/3/02.jpg",
          "/products/anicy/3/03.jpg",
          "/products/anicy/3/04.jpg",
          "/products/anicy/3/05.jpg",
          "/products/anicy/3/06.jpg",
        ],
      },
      {
        name: "4-Way Imported Track Pant — Machine Elastic",
        description:
          "A streamlined tapered track pant with a comfortable gathered waistband, practical zippered side pockets and a clean low-profile finish. Built for an understated sporty look that transitions easily from training to everyday wear.",
        images: [
          "/products/anicy/4/01.jpg",
          "/products/anicy/4/02.jpg",
          "/products/anicy/4/03.jpg",
          "/products/anicy/4/04.jpg",
          "/products/anicy/4/05.jpg",
          "/products/anicy/4/06.jpg",
        ],
      },
      {
        name: "4-Way Imported Bermuda",
        description:
          "A modern athletic bermuda with a relaxed fit, elastic drawstring waist and deep side pockets. Its clean styling and flexible silhouette make it suitable for gym sessions, outdoor activities and everyday casual wear.",
        images: [
          "/products/anicy/5/01.jpg",
          "/products/anicy/5/02.jpg",
          "/products/anicy/5/03.jpg",
          "/products/anicy/5/04.jpg",
          "/products/anicy/5/05.jpg",
        ],
      },
      {
        name: "4-Way Heavy Track Pant — Belt Elastic",
        description:
          "A robust full-length track pant with a tapered athletic cut, drawstring waist and zipped side pockets. The heavier construction gives the silhouette a more substantial feel while retaining the flexibility expected from activewear.",
        images: [
          "/products/anicy/6/01.jpg",
          "/products/anicy/6/02.jpg",
          "/products/anicy/6/03.jpg",
          "/products/anicy/6/04.jpg",
          "/products/anicy/6/05.jpg",
          "/products/anicy/6/06.jpg",
        ],
      },
      {
        name: "4-Way Heavy Track Pant — Machine Elastic",
        description:
          "A heavier-duty track pant with a clean tapered profile and elasticated waistband. Finished with practical side storage and a minimalist sporty appearance, making it suited to training as well as everyday movement.",
        images: [
          "/products/anicy/7/01.jpg",
          "/products/anicy/7/02.jpg",
          "/products/anicy/7/03.jpg",
          "/products/anicy/7/04.jpg",
          "/products/anicy/7/05.jpg",
          "/products/anicy/7/06.jpg",
        ],
      },
      {
        name: "4-Way Cargo Track Pant",
        description:
          "A functional cargo-inspired track pant combining a tapered athletic silhouette with multiple utility pockets. The side cargo compartments add practicality without losing the clean, modern activewear aesthetic.",
        images: [
          "/products/anicy/8/01.jpg",
          "/products/anicy/8/02.jpg",
          "/products/anicy/8/03.jpg",
          "/products/anicy/8/04.jpg",
          "/products/anicy/8/05.jpg",
          "/products/anicy/8/06.jpg",
        ],
      },
    ],
  },
